...
header-includes:
  - |
    ...
    <meta property="article:modified_time" content="2026-07-17T14:45:00+05:30">
resources:
...
<div class="enumeration-examples" aria-label="Three stages of the exhaustive enumeration">
  <figure>
    <span class="example-kicker">In the 1,448 only</span>
  ...
  <figure>
    <span class="example-kicker">In the 652, not the 408</span>
  ...
  <figure>
    <span class="example-kicker">In the 408</span>
...
<div class="resource-grid">
  <a class="resource-card draft-link" href="https://github.com/Mohan-Rajendran/math-nomad" target="_blank" rel="noreferrer">
    <span class="resource-type">Code · GitHub</span>
    <h3>Planned reproducibility companion</h3>
    <p>The generator and Burnside ledger are planned for the article’s repository folder and have not yet been added.</p>
    <strong>Open the website repository <span aria-hidden="true">↗</span></strong>
  </a>
...
```{=html}
<h2 id="keywords-heading">Ideas connected in this article</h2>
