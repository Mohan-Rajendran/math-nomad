...
<script type="application/ld+json">
{
  ...
  "dateModified": "2026-07-17T14:45:00+05:30",
...
<div class="hero-inner">
  ...
  <p class="standfirst">How a puzzle based on kolam tiles meet graph theory, Boolean satisfiability, and the mathematics of symmetry.</p>
  <div class="article-meta">
    <span class="avatar" aria-hidden="true">MR</span>
    <span><strong>Mohan R</strong><small>17 July 2026 · 14 min read</small></span>
  </div>
</div>
<div class="hero-grid">
  <img src="kolam-13-hero.webp" alt="Completed Kolam 13 from the catalogue" width="900" height="900">
</div>
```
:::
...
<p>On this page</p>
<ol>
  <li><a href="#threshold">Kolam at the threshold</a></li>
...
<aside class="margin-quote">
  <span><b>கோலம்</b><small>kōlam</small></span>
...
<div class="shape-count" aria-label="Six kolam shapes and their orientation counts">
  <div><img src="tile-type-0000-m1.webp" width="280" height="280" alt="Closed-loop kolam tile"><strong>1 tile</strong></div>
  <div><img src="tile-type-0001-m4.webp" width="280" height="280" alt="One-sided kolam tile"><strong>4 tiles</strong></div>
  <div><img src="tile-type-0011-m4.webp" width="280" height="280" alt="Corner kolam tile"><strong>4 tiles</strong></div>
  <div><img src="tile-type-0101-m2.webp" width="280" height="280" alt="Straight kolam tile"><strong>2 tiles</strong></div>
  <div><img src="tile-type-0111-m4.webp" width="280" height="280" alt="Three-sided kolam tile"><strong>4 tiles</strong></div>
  <div><img src="tile-type-1111-m1.webp" width="280" height="280" alt="Four-sided kolam tile"><strong>1 tile</strong></div>
</div>
...
<figure class="tile-catalogue">
  <img src="kolam-tiles.webp" width="1200" height="1200" alt="The sixteen square kolam tiles labelled from 0000 to 1111 in east, north, west, south order">
...
<details class="hint-box">
  ...
  <p>A corner has two outward-facing sides. At the top-left corner, both the north and west bits must be 0. Conversely, <code>1111</code> cannot lie on the boundary and must occupy one of the four central cells.</p>
</details>
...
<div class="enumeration-examples">
  <figure>
    <img src="enumeration-examples.svg" width="1500" height="610" loading="lazy" alt="A horizontally legal row that cannot be extended, a locally valid board whose nonzero part is disconnected, and an accepted connected board">
    <figcaption>A horizontally legal row that cannot be extended, a locally valid board whose nonzero part is disconnected, and an accepted connected board.</figcaption>
  </figure>
</div>
...
<div class="resource-grid">
  <div class="resource-card">
    <span class="resource-type">Code · GitHub</span>
    <h3>Code on GitHub</h3>
    <p>The generator and Burnside ledger will live with the article’s reproducibility material.</p>
    <a href="https://github.com/Mohan-Rajendran/math-nomad" target="_blank" rel="noreferrer"><strong>Open the website repository <span aria-hidden="true">↗</span></strong></a>
  </div>
  <div class="resource-card">
    <span class="resource-type">Catalogue · PDF · 2 pages</span>
    <h3>All 51 completed kolams</h3>
    <p>One canonical representative from every square-symmetry class, rendered from the exact enumeration.</p>
    <a href="fifty-one-kolams.pdf" target="_blank"><strong>Open the catalogue <span aria-hidden="true">↗</span></strong></a>
  </div>
</div>
```
...
<figure class="pdf-embed">
  ...
  <figcaption>All 51 representatives are embedded above. Each panel stands for one <i>D</i><sub>4</sub>-orbit, so its seven rotated or reflected copies are omitted. If your browser does not show embedded PDFs, <a href="fifty-one-kolams.pdf" target="_blank">open the catalogue in a new tab</a>.</figcaption>
</figure>
...
:::: {#keywords .article-section .article-keywords aria-labelledby="keywords-heading"}
<p class="section-number">Keywords</p>

## Ideas connected in this article {#keywords-heading}

```{=html}
<div class="keyword-links" aria-label="Article keywords">
  <a href="#threshold" data-topic="pulli-kolam">Pulli kolam</a>
  <a href="#threshold" data-topic="sikku-kolam">Sikku kolam</a>
  <a href="#six-to-sixteen" data-topic="kolam-tiles">Kolam tiles</a>
  <a href="#bits" data-topic="graph-theory">Graph theory</a>
  <a href="#sat" data-topic="boolean-satisfiability">Boolean satisfiability</a>
  <a href="#sat" data-topic="enumeration">Combinatorial enumeration</a>
  <a href="#symmetry" data-topic="dihedral-symmetry">Dihedral symmetry</a>
  <a href="/writing/topics/burnside-lemma/" data-topic="burnside-lemma">Burnside’s lemma</a>
</div>
```
...
## Notes and further reading {#notes-heading}
...
<div class="article-end">
  ...
  <p>The code certifies the count; the completed kolams remind us why the objects were worth counting.</p>
</div>
