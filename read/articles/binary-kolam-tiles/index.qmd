...
categories: [kolams, combinatorics, graphs]
...
::: {.callout-note title="Continue in the laboratory"}
[Open the Kolam Tile Laboratory](https://kolam-tile-builder.littleboy300.chatgpt.site) to build a configuration, inspect violated conditions and try the orbit challenge.
:::
